...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.5943648676461575; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 11.384667168354614;

        // feedforward parameters (in tick units)
        public double kS = 1.2115030663384143;
        public double kV = 0.14664807621182774;
